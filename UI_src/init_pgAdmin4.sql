...
GRANT ALL PRIVILEGES ON TABLE project_activities TO postgres;
GRANT USAGE, SELECT ON SEQUENCE project_activities_id_seq TO postgres;
...
GRANT SELECT ON project_activities_view TO postgres;