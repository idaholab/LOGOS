...
- :xmlNode:`solverOptions`, *optional*
  ...
  the Wasserstein distance (see Section :ref:`sec-DROCapitalBudgeting`).

  If the problem type uses conditional value-at-risk (see
  Section :ref:`sec-CVaR`), additional options are available:
